...
/**
 * The features page as a shape file: `pure compile` precompiles it into
 * views/features.pure.php, which app/controllers/FeaturesController.php renders
 * through view() and PlainFeaturesController.php through plain().
 */
function FeaturesPageShape(): Shape
{
    static $shape;
    ...
    return $shape ??= Compile::shape(
        html(
            ...
            body(
                IconSheet(),
                Slot::child('content', FeaturesBodyShape())
            )
        )
    );
}

return FeaturesPageShape();
